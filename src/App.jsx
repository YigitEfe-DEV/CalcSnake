...
function SnakeScreen({ game, highScore, onRestart, onTogglePause }) {
  return (
    <div className="snake">
      ...
      <div className="snake__grid" role="application" aria-label="Snake game screen">
        {Array.from({ length: GRID_SIZE * GRID_SIZE }, (_, index) => {
          ...
          const isSnake = game.snake.some((segment, segmentIndex) => segment.x === x && segment.y === y && segmentIndex === 0);
          const isBody = game.snake.some((segment, segmentIndex) => segment.x === x && segment.y === y && segmentIndex > 0);
